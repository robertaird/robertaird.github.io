...
_.partition = function (array, func) {
    ...
    // return array that contains two arrays of truthy and falsey 
    var newArr = [];
    newArr.push(_.filter(array, func));
    newArr.push(_.reject(array, func));
    return newArr;
};
...
_.map = function (collection, func) {
    ...
    _.each(collection, function(value, index, collection) {
        newArr.push(func(value, index, collection));
    });
    return newArr;
};
